...
The comparison evaluates a fully fine-tuned ResNet-50, a frozen DINOv2 backbone with supervised prediction layers, and InternVL3-2B without parameter updating on the same 2,014-building evaluation set and with the same attribute definitions.
