...
\paragraph{E1a: Building type.}
ResNet-50 and DINOv2 differed by 0.014 in accuracy but their ordering reversed for macro F1. Figure~\ref{fig:type_confusion} shows that both configurations recalled more than 0.92 of the AB buildings and none of the 12 MFH buildings. DINOv2 recalled 0.774 of TH and 0.560 of SFH, while ResNet-50 recalled 0.711 and 0.320. The gap between accuracy and macro F1 therefore coincided with uneven recall across the four classes.
...
\begin{table}[htbp]
	...
	\begin{tblr}{
		...
		Direct image condition & DINOv2 & 0.595 & \textbf{0.601} & \textbf{0.597} \\
		...
		Predicted attribute condition & ResNet-50 & 0.550 & 0.518 & 0.488 \\
		Predicted attribute condition & InternVL3-2B & 0.527 & 0.528 & 0.527 \\
		\bottomrule
	\end{tblr}
\end{table}
...
\begin{table}[htbp]
	...
	\begin{tblr}{
		...
		Reference attribute condition & LightGBM & 0.171 & \textbf{0.358} & \textbf{0.660} \\
		...
		Predicted attribute condition & DINOv2 & 0.151 & 0.297 & 0.589 \\
		Predicted attribute condition & ResNet-50 & 0.148 & 0.284 & 0.588 \\
		Predicted attribute condition & InternVL3-2B & 0.131 & 0.277 & 0.596 \\
		\bottomrule
	\end{tblr}
\end{table}
