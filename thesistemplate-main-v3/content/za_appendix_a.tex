...
The implementation selects the assembly with the highest U-value when the workbook contains several subperiod assemblies within one TABULA-NL period. Window U-values are assigned directly by construction period.
