...
First, the workflow uses the scikit-learn implementation of \texttt{StratifiedGroupKFold} to generate five shuffled subsets with random seed 42 while attempting to balance the distribution of a composite stratification label \parencite{pedregosa2011}.
...
The coefficient $h_{tr}$ is calculated by summing the products of the representative U-values and their corresponding reconstructed element areas and dividing the total by estimated floor area \parencite{loga2013calculation}.
