...
|---|---:|---:|---:|---|---:|---:|
| DINOv2 frozen | 2,014 | 0.826 | **0.149** | [0.132, 0.167] | 12.7% | +0.106 |
| ResNet-50 ft | 2,014 | 0.827 | **0.155** | [0.137, 0.174] | 13.5% | +0.093 |
| InternVL3 (ZS) | 2,014 | 0.342 | **0.474** | [0.449, 0.500] | 26.3% | +0.169 |

Separation: **3.2×** between DINOv2 frozen (joint 0.826) and InternVL3 (ZS) (joint 0.342), non-overlapping CIs. On the EPC-label instrument the same two models differ by 1.09×.
...
|---|---:|---:|---:|
| DINOv2 frozen | 0.149 | 0.149 | 0.149 |
| ResNet-50 ft | 0.155 | 0.155 | 0.155 |
